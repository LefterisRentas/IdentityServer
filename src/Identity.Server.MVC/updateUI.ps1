iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/Identity.Server.MVC/IdentityServer4.Quickstart.UI.AspNetIdentity/main/getmain.ps1'))	
