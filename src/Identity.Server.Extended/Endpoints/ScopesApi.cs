...
/// <summary>
/// Scopes Management API endpoints.
/// </summary>
public static class ScopesApi
{
    /// <summary>
    /// Maps the scopes management API.
    /// </summary>
    /// <param name="routes"></param>
    /// <returns></returns>
    public static void MapScopesManagement(this IEndpointRouteBuilder routes)
    {
